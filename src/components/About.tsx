      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-12 md:gap-14 items-start">
          ...
          <div className="relative">
            <div className={`${photoFrame} ml-[18%] w-[70%]`}>
              <img
                src={runwayImg}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute -right-6 bottom-5 w-[60%] bg-card border border-border p-4 shadow-[0_18px_40px_-18px_rgba(0,0,0,0.45)] transition-transform duration-300 hover:scale-[1.02]"
